  ...
  return (
    ...
    >
            ...
            <Box sx={{ width: '100%' }}>
              <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                <Tabs value={value} onChange={handleChange} aria-label="basic tabs">
                  <Tab label="Documentação Obra" {...a11yProps(0)} />
                  <Tab label="Dados da Obra" {...a11yProps(1)} />
                ...
                <div className="row g-3">
                  ...
                  <div className="col-sm-3">
                    ...
                    >
                      ...
                      <option value="TELEQUIPE/EQUIPE">AMBOS</option>
                    </Input>
                  </div>
                </div>
                <br></br>
      ...
      <ModalFooter style={{ backgroundColor: 'white' }}>
        <Button color="success" onClick={ProcessaSalvar} disabled={modoVisualizador()}>
          Salvar
        </Button>
