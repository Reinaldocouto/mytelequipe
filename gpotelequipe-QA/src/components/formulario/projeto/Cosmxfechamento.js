...
import Fechamentocosmxedicao from '../fechamento/Fechamentocosmxedicao';

const Cosmxfechamento = ({ setshow, show }) => {
    ...
    return (
        ...
        >
            <ModalHeader toggle={togglecadastro.bind(null)} style={{ backgroundColor: "white" }}>Fechamento Cosmx</ModalHeader>
...
Cosmxfechamento.propTypes = {
    show: PropTypes.bool.isRequired,
    setshow: PropTypes.func.isRequired,
};

export default Cosmxfechamento;
