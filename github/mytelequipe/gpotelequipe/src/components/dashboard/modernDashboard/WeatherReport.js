      ...
      <div className="table-responsive border-bottom">
        <Table borderless className="mt-3 mb-4 pb-2">
          <tbody style={{ backgroundColor: 'white' }}>
            <tr>
              <td style={{ backgroundColor: 'white' }} className="text-muted">
                Wind
              </td>
              <td style={{ backgroundColor: 'white' }}>ESE 17 mph</td>
            </tr>
            <tr>
              <td style={{ backgroundColor: 'white' }} className="text-muted">
                Humidity
              </td>
              <td style={{ backgroundColor: 'white' }}>83%</td>
            </tr>
            <tr>
              <td style={{ backgroundColor: 'white' }} className="text-muted">
                Pressure
              </td>
              <td style={{ backgroundColor: 'white' }}>28.56 in</td>
            </tr>
            <tr>
              <td style={{ backgroundColor: 'white' }} className="text-muted">
                Cloud Cover
              </td>
              <td style={{ backgroundColor: 'white' }}>78%</td>
            </tr>
            <tr>
              <td style={{ backgroundColor: 'white' }} className="text-muted">
                Ceiling
              </td>
              <td style={{ backgroundColor: 'white' }}>25760 ft</td>
            </tr>
          </tbody>
        </Table>
      </div>
      ...
      <Row className="mt-4">
        {weatherData.map((wdata) => (
          <Col xs="3" className="text-center" key={wdata.icon}>
            ...
            <span className="d-block text-muted text-nowrap pt-2">{wdata.time}</span>
