...
import Ericssonedicaoadic from './Ericssonedicaoadic';
import exportExcel from '../../../data/exportexcel/Excelexport';
import Notpermission from '../../../layouts/notpermission/notpermission';

const Ericssonadicional = ({ setshow, show }) => {
    ...
    return (
        ...
        >
            <ModalHeader toggle={togglecadastro.bind(null)} style={{ backgroundColor: "white" }}>Adcional Obras Ericsson - Item sem ID</ModalHeader>
...
Ericssonadicional.propTypes = {
    show: PropTypes.bool.isRequired,
    setshow: PropTypes.func.isRequired,
};

export default Ericssonadicional;
