...
const Acessotelefonica = ({ setshow, show }) => {
   ...
   /* const params = {
    ...
    const columns = [
        ...
        },
        {
            ...
            valueFormatter: (parametros) =>
                parametros.value ? new Intl.DateTimeFormat('pt-BR', { dateStyle: 'short' }).format(parametros.value) : '',
            editable: false,
        },
        {
    ...
    return (
        <>
            ...
            >
                <ModalHeader>Acesso - Telefonica</ModalHeader>
                <ModalBody>
                    {mensagem.length > 0 ? (
...
Acessotelefonica.propTypes = {
    show: PropTypes.bool.isRequired,
    setshow: PropTypes.func.isRequired,
};

export default Acessotelefonica;
