...
function TCategoria.NovoCadastro(out erro: string): integer;
var
  qry: TFDQuery;
begin
  try
...
function TCategoria.Lista(const AQuery: TDictionary<string, string>; out erro: string): TFDQuery;
var
  qry: TFDQuery;
begin
  try
...
function TCategoria.Listaid(const AQuery: TDictionary<string, string>; out erro: string): TFDQuery;
var
  qry: TFDQuery;
begin
  try
