...
begin
  ...
  try
    ...
    if AQuery.TryGetValue('regional', regional) and (regional.Trim <> '') and (regional.Trim <> 'Todos') then
    begin
      SQL.Add('  AND obrasericssonlistasites.regional LIKE :regional');
      Params.CreateParam(ftString, 'regional', ptInput);
      ParamByName('regional').DataType := ftString;
