...
import Fechamentozteedicao from '../fechamento/Fechamentozteedicao';

const Ztefechamento = ({ setshow, show }) => {
  ...
  return (
    ...
    >
      <ModalHeader toggle={togglecadastro.bind(null)} style={{ backgroundColor: "white" }}>Fechamento ZTE</ModalHeader>
...
Ztefechamento.propTypes = {
  show: PropTypes.bool.isRequired,
  setshow: PropTypes.func.isRequired,
};

export default Ztefechamento;
