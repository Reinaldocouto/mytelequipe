...
const Telefonicaacionamentoedicao = ({
  setshow,
  show,
  ididentificador,
  atualiza,
    ...
    const valorpopj = [
        ...
        },
        {
            ...
            renderCell: ({ row: { porcentagem } }) => {
                const color = porcentagem === null || porcentagem === 0
                    ? grey[350]
...
Telefonicaacionamentoedicao.propTypes = {
...
export default Telefonicaacionamentoedicao;
