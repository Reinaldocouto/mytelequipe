...
import Fechamentoericssonedicao from '../fechamento/Fechamentoericssonedicao';
import Notpermission from '../../../layouts/notpermission/notpermission';
import modoVisualizador from '../../../services/modovisualizador';

const Ericssonfechamento = ({ setshow, show }) => {
...
Ericssonfechamento.propTypes = {
  show: PropTypes.bool.isRequired,
  setshow: PropTypes.func.isRequired,
};

export default Ericssonfechamento;
