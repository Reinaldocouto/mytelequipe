...
const Relatoriofechamentohistorico = ({ setshow, show }) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      type: 'string',
      editable: false,
      valueGetter: (parametros) => parametros.row?.escopo || parametros.row?.brevedescricao || '',
      renderCell: (parametros) => <div style={{ whiteSpace: 'pre-wrap' }}>{parametros.value}</div>,
    },
    {
      field: 'quantidade',
    ...
    },
    {
      ...
      type: 'string',
      editable: false,
      valueGetter: (parametros) => parametros.row?.tarefas || parametros.row?.brevedescricao || '',
      renderCell: (parametros) => <div style={{ whiteSpace: 'pre-wrap' }}>{parametros.value}</div>,
    },
    {
      field: 'valor',
    ...
    },
    {
      ...
      type: 'string',
      editable: false,
      valueGetter: (parametros) => parametros.row?.observacao || '',
      renderCell: (parametros) => <div style={{ whiteSpace: 'pre-wrap' }}>{parametros.value}</div>,
    },
    {
      field: 'tipopagamento',
  ...
  const gerarexcel = () => {
    const excelData = totalacionamento.map((item) => {
      ...
      return {
        ...
        ESCOPO: item.escopo || item.brevedescricao || '',
        QUANTIDADE: item.quantidade,
        'CODIGO LPU VIVO': item.codigolpuvivo,
        TAREFAS: item.tarefas || item.brevedescricao || '',
