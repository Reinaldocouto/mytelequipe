...
import Demonstrativofiltro from '../../../pages/demonstrativo/Demonstrativofiltro';
import Demonstrativores from '../../../pages/demonstrativo/Demonstrativores';
import Notpermission from '../../../layouts/notpermission/notpermission';
import api from '../../../services/api';

const Demonstrativoview = ({ setshow, show }) => {
    ...
    return (
        <>
            ...
            >
                <ModalHeader>Demonstrativo</ModalHeader>
                <ModalBody>
                    <div>
                        {permission && (
