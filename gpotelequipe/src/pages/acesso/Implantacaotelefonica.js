...
const Implantacaotelefonica = ({ setshow, show }) => {
   ...
   /* const params = {
    ...
    return (
        <>
            ...
            >
                <ModalHeader>Pedido Implantação - Telefonica</ModalHeader>
                <ModalBody>
                    {mensagem.length > 0 ? (
...
Implantacaotelefonica.propTypes = {
    show: PropTypes.bool.isRequired,
    setshow: PropTypes.func.isRequired,
};

export default Implantacaotelefonica;
